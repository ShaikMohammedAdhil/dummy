          ...
          <div className="lg:w-8/12">
            <div className="bg-white rounded-md shadow-sm overflow-hidden">
                  ...
                  <div className="p-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                    ...
                    <div className="md:col-span-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <Link to={`/product/${item.id}`} className="text-sm font-medium text-gray-800 hover:text-flipkart-blue">
                            {item.name}
                          </Link>
                          ...
                          <div className="md:hidden flex items-center mt-2">
                            ...
                            {item.originalPrice && (
                              <>
                                ...
                                <span className="text-flipkart-green text-xs ml-2">
              ...
              <div className="p-4 flex justify-between items-center border-t">
                <Link 
                  to="/"
                  className="text-flipkart-blue font-medium text-sm hover:underline"
                >
                  Continue Shopping
                </Link>
              </div>
          ...
          <div className="lg:w-4/12">
            <div className="bg-white rounded-md shadow-sm p-4">
              ...
              <div className="border-t border-b py-3 mb-4">
                ...
                <div className="text-flipkart-green text-sm font-medium mt-1">
              ...
              <Link
                to="/checkout"
                className="block w-full bg-flipkart-orange hover:bg-orange-600 text-white text-center py-3 font-medium rounded-sm transition-colors"
              >
                Proceed to Checkout
              </Link>
            </div>
