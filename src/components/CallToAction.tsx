      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            <motion.button 
              className="inline-flex items-center justify-center px-6 py-3 bg-white text-primary-800 font-medium rounded-full 
          ...
          >
            ...
            {/* Decorative elements */}
            <div className="absolute -top-6 -right-6 w-12 h-12 bg-primary-400 rounded-full opacity-70"></div>
